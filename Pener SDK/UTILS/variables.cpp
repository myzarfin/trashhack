...
namespace SETTINGS
{
	...
	{
		std::string file_path = "C:\\trashhack configs\\" + file_name + ".cfg";
	...
	{
		CreateDirectory("C:\\trashhack configs", NULL);
	...
	{
		std::string file_path = "C:\trashhack configs\\BlankConfig.cfg";
	...
	std::vector<std::string> CSettings::GetConfigs()
	{
		...
		WIN32_FIND_DATA ffd;
		auto directory = "C:\\trashhack configs\\*";
